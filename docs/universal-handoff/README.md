...
| Overlap with `JR-VALIDATION-004` | This doc is the **operational checklist**; category **VAL-CAT-06** in [`../validation/categories.md`](../validation/categories.md); doc-only tiers in [`../validation/doc-only-init-evidence.md`](../validation/doc-only-init-evidence.md) (`JR-VALIDATION-002`) |
