...
| Overlap with `JR-VALIDATION-004` | This doc is the **operational checklist** (**IND-*** / **ORCH-IND-***); validation layer — [`../validation/self-containment-checks.md`](../validation/self-containment-checks.md) (**VAL-IND-FAM-***, **VAL-EVID-02/03/04/05** for **VAL-CAT-06**) |
