...
**Related:** [`source-registry.md`](./source-registry.md) (capability → Jarvis copy sources); commands and scripts — [`commands.md`](./commands.md) (`JR-STACK-003`); testing — [`testing.md`](./testing.md) (`JR-STACK-004`); deps must match manifests — [`dependencies.md`](./dependencies.md) (`JR-STACK-006`).
