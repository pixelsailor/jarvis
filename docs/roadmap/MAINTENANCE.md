...
| Universal orchestration task-folder model, manifest schema, artifact ownership, gates vs merge-ready, init/run paths | [`../orchestration/README.md`](../orchestration/README.md) |
