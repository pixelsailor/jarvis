...
| Validation categories and evidence model (init vs change) | [`../validation/README.md`](../validation/README.md), [`categories.md`](../validation/categories.md), [`doc-only-init-evidence.md`](../validation/doc-only-init-evidence.md); checklist rows in [`../universal-validation/README.md`](../universal-validation/README.md) |
