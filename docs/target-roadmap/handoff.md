...
| `PROJ-STACK-*` | Yes when repo has tooling | `docs/stack/stack-profile.md` confirmed; `PROJ-STACK-001` / `docs/stack/commands.md` and README § Development verified from manifests (`JR-STACK-001`, `JR-STACK-003`) |
