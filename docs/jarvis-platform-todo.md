# Jarvis platform roadmap (redirect)

The platform roadmap was split for clearer agent reads and safer backlog edits.

**Start here:** [`roadmap/README.md`](./roadmap/README.md)

| Need | File |
| --- | --- |
| Terminology, flows, handoff checklist | [`roadmap/platform-spec.md`](./roadmap/platform-spec.md) |
