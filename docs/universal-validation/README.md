...
**Related (when present):** [`../universal-pr-commit/README.md`](../universal-pr-commit/README.md) (PR template and guide link checklist rows); [`../orchestration/README.md`](../orchestration/README.md) (`JR-ORCH-001`/`002` — task folders and manifest); [`../orchestration/gates-and-checks.md`](../orchestration/gates-and-checks.md) (`JR-ORCH-004` — lifecycle vs merge-ready vs handoff); [`../orchestration/artifact-ownership.md`](../orchestration/artifact-ownership.md) (`JR-ORCH-003`); [`JR-ORCH-005`](../orchestration/init-paths.md), [`JR-ORCH-006`](../orchestration/loops-and-rework.md); [`../validation/README.md`](../validation/README.md) (`JR-VALIDATION-001` categories; `002`–`005` evidence tiers).

## When to scaffold

| Initialization path | Validation checklist |
| --- | --- |
| **Small** | **Required** — minimal `docs/validation-checklist.md` on all paths ([`init-paths.md`](../orchestration/init-paths.md) § A.3); **MG-*** / **TST-*** rows apply at **change** time, not doc-only init ([`doc-only-init-evidence.md`](../validation/doc-only-init-evidence.md)) |
...
| [`self-containment-checks.md`](../validation/self-containment-checks.md) (`JR-VALIDATION-004`) | **VAL-CAT-06** validation layer; **VAL-IND-FAM-***; operational rows in target `handoff-self-containment.md` |
| [`completion-claims.md`](../validation/completion-claims.md) (`JR-VALIDATION-005`) | **VAL-CLAIM-*** — Jarvis vs human completion authority |
